    ...
    <div className="mb-4 flex flex-col gap-3">
      <div className="relative">
        ...
        <input
          ...
          autoComplete="off"
          enterKeyHint="search"
          className="w-full rounded-xl border border-black/8 bg-surface py-2.5 pl-10 pr-3 text-base text-misa-800 shadow-[var(--shadow-card)] outline-none ring-accent/30 placeholder:text-misa-400 focus:border-accent focus:ring-2"
        />
      </div>

      <div>
        <div className="mb-1 text-sm font-medium uppercase tracking-wider text-misa-400">
